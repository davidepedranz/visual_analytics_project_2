...
% If the comparison is between following types (i.e. $2$ types whose name are successive in alphabetical order), the task can still be done,
% but for types which 
...
An alternative solution is to use a ``small multiple design'', i.e. create a visualization for a single type and replicate it multiple times.
